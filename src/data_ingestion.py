...
def load_data(data_url: str)-> dict:
    ...
    try:
        ...
        logger.error("failded to parse csv file %s",e)
        raise
    except Exception as e:
...
def main():
    try:
        ...
        data_path= "https://raw.githubusercontent.com/AnandVadgama/dataset/refs/heads/main/spam.csv"
